            ...
            <div className="container relative">
                ...
                <div className="relative text-center mt-3">
                    <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1">
                        <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-indigo-600"><Link href="/index-shop">waybeyond.tech</Link></li>
            ...
            <div className="container">
                <div className="md:flex justify-center">
                    <div className="lg:w-3/5 text-center">
                        <h5 className="text-2xl font-semibold">waybeyond.tech Shop</h5>
