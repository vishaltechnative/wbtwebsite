                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                        ...
                        <div className="lg:col-span-7 md:col-span-6">
                            ...
                            <div className="my-5">
                                <Link href="#"><Image src="/images/app/app.png" width={167} height={57} className="m-1 inline-block" alt="" /></Link>
                                <Link href="#"><Image src="/images/app/playstore.png" width={167} height={57} className="m-1 inline-block" alt="" /></Link>
                            </div>
