    ...
    return(
        <div className={className}>
            <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                ...
                <div className="md:col-span-6">
                    <p className="text-slate-400 max-w-xl">Start working with waybeyond.tech that can provide everything you need to generate awareness, drive traffic, connect.</p>
                </div>
            </div>
