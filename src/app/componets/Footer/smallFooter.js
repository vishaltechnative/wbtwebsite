...
export default function SmallFooter(){
    return(
            <footer className="footer bg-dark-footer relative text-gray-200 dark:text-gray-200">
                <div className="py-0 px-0 border-t border-slate-800">
                    <div className="container relative text-center">
                        <div className="grid lg:grid-cols-12 md:grid-cols-3 grid-cols-1 items-center">
                            <div className="lg:col-span-2 md:text-start text-center">
                                <Link href="/" className="text-[22px] focus:outline-none">
                                    <Image style={{maxWidth: '50%'}} src="/images/web-light.png" width={138} height={24} className="mx-auto md:me-auto md:ms-0" alt="" />
                                </Link>
                            </div>
