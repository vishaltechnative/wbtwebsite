    ...
    return(
            <div className="container relative" id="review">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">What Our Clients Say</h3>
                    }

                    <p className="text-slate-400 max-w-xl mx-auto">Discover the impact of our services through the words of satisfied clients who have experienced excellence firsthand.</p>
                </div>
