...
import {PiShoppingCart,PiBookOpenText} from 'react-icons/pi'
import {GoClock} from "react-icons/go"
import {FaSignal} from "react-icons/fa"
import {BiCube,BiBookReader} from "react-icons/bi"
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 text-center mt-10">
                    ...
                    <div className="flex items-center mx-auto mt-3">
                        <Image src={data?.image2} width={40} height={40} className="h-10 w-10 rounded-full shadow-md dark:shadow-gray-800" alt="" />
