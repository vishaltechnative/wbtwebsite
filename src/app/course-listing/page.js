        ...
        <section className="relative table w-full py-36 lg:py-44  bg-no-repeat bg-center bg-cover" style={{backgroundImage:"url('/images/course/cta.jpg')"}}>
            ...
            <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px]  mb-0 inline-flex items-center space-x-1">
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white/50 hover:text-white"><Link href="/index-course">Way Beyond Tech</Link></li>
                                    ...
                                    <div className="relative overflow-hidden">
                                        ...
                                        <div className="absolute start-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                                            <div className="pb-4 ps-4 flex items-center">
                                                <Image src={data.image2} width={30} height={30} className="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
                                                <div className="ms-3">
