        ...
        <section className="relative table w-full md:pb-24 pb-16 mt-28">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto">We are a huge marketplace dedicated to connecting great artists of all waybeyond.tech with their fans and unique token collectors!</p>
                </div>
