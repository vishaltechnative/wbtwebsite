...
export default function NftCreatorProfile(props){
    ...
    const createrData = NftServices.find((creater)=>creater?.Id === parseInt(props?.params?.id || 0));
                            ...
                            return(
                                    <div key={index} className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800 hover:shadow-lg dark:hover:shadow-gray-800 duration-500 ease-in-out">
                                        <div className="relative">
                                            <Image width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} src={item.image} alt="" />
