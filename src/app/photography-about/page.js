...
export default function PhotographyAbout(){
    ...
    const about = [
        {
            iamge: "/images/client/amazon-prime-video-logo.svg"
        },
        {
            iamge: "/images/client/angular-3.svg"
        },
        {
            iamge: "/images/client/huawei-2.svg"
        },
        {
            iamge: "/images/client/bosch.svg"
        },
        {
            iamge: "/images/client/coinbase.svg"
        },
        {
            iamge: "/images/client/husd-3.svg"
        },
        {
            iamge: "/images/client/intercom-1.svg"
        },
        {
            iamge: "/images/client/linkedin-logo-2013-1.svg"
        },
        {
            iamge: "/images/client/yamaha-2-1.svg"
        },
        {
            iamge: "/images/client/logo-donington-park.svg"
        },
        {
            iamge: "/images/client/microsoft-office-2013.svg"
        },
        {
            iamge: "/images/client/netflix-3.svg"
        },
        {
            iamge: "/images/client/python-3.svg"
        },
        {
            iamge: "/images/client/redbull-1.svg"
        },
        {
            iamge: "/images/client/zoom-communications-logo.svg"
        },
        {
            iamge: "/images/client/suntech-power-logo.svg"
        },
        {
            iamge: "/images/client/v-power-1.svg"
        }
    ]
    return(
        <>
                    ...
                    {about.map((data,index) => {
                        return (
                            <div className="mx-auto" key={index}>
                                <Image src={data.iamge} width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="h-[110px] w-[110px] grayscale hover:grayscale-0 duration-500 ease-in-out" alt="" />
                            </div>
                        )
                    })}
