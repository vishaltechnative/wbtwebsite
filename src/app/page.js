...
export default function PageComingsoon() {
    ...
    useEffect(() => {
          ...
          var eventCountDown = new Date("December 30, 2023 16:37:52").getTime();
  ...
  return (
    <>
        <section className="relative  bg-no-repeat bg-center bg-cover" style={{backgroundImage:"url('/images/utility.jpg')"}}>
          <video className="commingSoonLogo" autoPlay muted loop id="myVideo" style={{position: 'fixed', right: 0, bottom: 0, minWidth: '100%', minHeight: '100%'}}>
            <source className="commingSoonLogo" src="/images/bgvideo.mp4" type="video/mp4"/>
          </video>
                ...
                <div className="grid grid-cols-1">
                    <div className="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
                        <div className="text-center" style={{display: 'flex', justifyContent: 'center'}}>
                            ...
                            <h2 className="text-white md:text-5xl text-3xl font-bold" style={{display: 'flex', alignItems: 'center'}}>waybeyond.tech</h2>
                            <Image src="/images/web-dark.png" width={78} height={68} className="mx-auto commingSoonLogo" alt=""/>
                            </Link>
                        </div>
                        <div className="title-heading text-center my-auto">
                            <h1 className="text-white mt-3 md:text-3xl text-2xl font-bold">We Are Coming Soon...</h1>
