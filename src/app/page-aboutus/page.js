        ...
        <section className="relative table w-full py-36 lg:py-44  bg-no-repeat bg-center bg-cover" style={{backgroundImage:"url('/images/company/aboutus.jpg')"}}>
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 text-center mt-10">
                    ...
                    <p className="text-slate-300 text-lg max-w-xl mx-auto">Way Beyond Tech is not just a company; it's a mindset. It's the belief that the limits of technology are only temporary roadblocks on the path to progress. We embrace complexity and see it as an opportunity to simplify. We thrive on collaboration, constantly seeking new perspectives, and forging partnerships that lead to groundbreaking results.</p>
                </div>
            </div>
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="lg:col-span-7 md:col-span-6">
                        <div className="lg:ms-5">
                            ...
                            <p className="text-slate-400 max-w-xl">Way Beyond Tech is not just a company; it's a mindset. It's the belief that the limits of technology are only temporary roadblocks on the path to progress. We embrace complexity and see it as an opportunity to simplify. We thrive on collaboration, constantly seeking new perspectives, and forging partnerships that lead to groundbreaking results.</p>
