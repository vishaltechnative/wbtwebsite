...
import { gymServices } from '../Data/data';
...
export default function IndexGym(){
    ...
    const gymImage = [
        {
            image: "/images/gym/01.jpg"
        },
        {
            image: "/images/gym/02.jpg"
        },
        {
            image: "/images/gym/03.jpg"
        },
        {
            image: "/images/gym/04.jpg"
        },
        {
            image: "/images/gym/05.jpg"
        },
        {
            image: "/images/gym/06.jpg"
        },
        {
            image: "/images/gym/07.jpg"
        },
        {
            image: "/images/gym/08.jpg"
        },
        {
            image: "/images/gym/09.jpg"
        },
        {
            image: "/images/gym/10.jpg"
        },
    ]
    ...
    const images = ["/images/gym/01.jpg", "/images/gym/02.jpg", "/images/gym/03.jpg", "/images/gym/04.jpg", "/images/gym/05.jpg", "/images/gym/06.jpg", "/images/gym/07.jpg", "/images/gym/08.jpg", "/images/gym/09.jpg", "/images/gym/10.jpg",]
                        ...
                        return (
                            ...
                            <div className="group relative block overflow-hidden transition-all duration-500" key={index} onClick={() => handleImageClick(index)} >
                                <Link href="#" onClick={() => handleImageClick(index)}  className="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                    <Image src={data.image} width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="transition-all duration-500 group-hover:scale-105" alt="Gym Images" />
                                </Link>
                            </div>
                        )
                    })
