...
import {MdKeyboardArrowRight,MdOutlineCollectionsBookmark} from "react-icons/md"
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <div className="flex">
                        ...
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold">How our <span className="text-indigo-600">waybeyond.tech</span> work ?</h5>
                    ...
                    <div className="flex">
                        <Icon.HelpCircle className="fea icon-ex-md text-indigo-600 me-3"></Icon.HelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold"> Is <span className="text-indigo-600">waybeyond.tech</span> safer to use with my account ?</h5>
