...
const BlogUserDetail = dynamic(()=>import('../componets/blogUserDetail'));
const BlogComment = dynamic(()=>import('../componets/blogComment'));
                                ...
                                <div className="tiny-single-item">
                                    <TinySlider settings={settings}>
                                        {services.map((item, index) => (
                                            <div className="tiny-slide" key={index}><Image src={item.image} width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}} className="rounded-md" alt="" /></div>
                                        ))}
                                    </TinySlider>
                                </div>
                            </div>
